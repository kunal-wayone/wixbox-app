...
// Mock ImagePath (replace with your actual image paths)
// Example: 
// export const ImagePath = {
//   signBg: require('../../assets/images/sign-bg.png'),
      ...
      <ScrollView
        ...
        <View className="mt-20">
          ...
          <View className="flex-row justify-center gap-4 my-4">
            <TouchableOpacity className="p-3 w-1/2 h-20 border border-gray-300 rounded-lg">
              <Image
            ...
            <TouchableOpacity className="p-3 w-1/2 border border-gray-300   rounded-lg">
              <Image
          ...
          <View className="items-center mb-4">
            <Text className="text-sm text-gray-600">
              ...
              <TouchableOpacity>
                <Text className="text-[#7248B3] font-bold">Login</Text>
              </TouchableOpacity>
            </Text>
          </View>
        </View>
