        ...
        <View className="mt-4 bg-primary-10 rounded-xl p-4 shadow-md">
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              resizeMode="contain"
            />
            <Text className="flex-1 text-gray-700 text-base">Google Pay</Text>
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              resizeMode="contain"
            />
            <Text className="flex-1 text-gray-700 text-base">PhonePe</Text>
            <View className="w-5 h-5 rounded-full border-2 border-primary-100 items-center justify-center">
        ...
        <View className="mt-4 bg-primary-10 rounded-xl p-4 shadow-md">
          <TouchableOpacity className="flex-row items-center py-3 border border-gray-300 rounded-lg">
            <MaterialIcons
              ...
              className="ml-3 mr-3"
            />
            <Text className="text-gray-700 text-base">Add New Card</Text>
          </TouchableOpacity>
        </View>
      </View>
        ...
        <View className="mt-4 bg-primary-10 rounded-xl p-4 shadow-md">
          <TouchableOpacity className="flex-row items-center py-3 border-b border-dashed border-gray-300">
            ...
            <View className="flex-1">
              <Text className="text-gray-700 text-base">Net Banking</Text>
          ...
          <TouchableOpacity className="flex-row items-center py-3">
            ...
            />
            <View className="flex-1">
              <Text className="text-gray-700 text-base">Pay on Delivery</Text>
              <Text className="text-gray-500 text-sm">
        ...
        <View className="flex-1 justify-center items-center bg-black/50">
          <View className="bg-white rounded-xl p-6 w-11/12 shadow-md">
            ...
            <View className="flex-row items-center justify-between bg-primary-10  mt-4 p-4 rounded-xl ">
              <Text className="text-gray-900 text-base w-1/2">
                Reserved for 23rd May 2025
              </Text>
              <View className="w-px h-8 bg-gray-300" />
              <Text className="text-gray-900 text-base w-1/2 px-4">
                Table No. 12
              </Text>
            </View>
            {/* View Map Button */}
            <TouchableOpacity className="flex-row items-center justify-center mt-4 py-3 bg-primary-90 rounded-xl">
              <MaterialIcons
                ...
                className="mr-2"
              />
              <Text className="text-white text-base">View Map</Text>
            </TouchableOpacity>
            {/* Back to Home Button */}
            <TouchableOpacity
              className="  border border-gray-300 py-3 px-4 rounded-xl mt-4"
              onPress={() => navigation.navigate("HomeScreen")}>
              <Text className="text-primary-80 text-center font-medium">
                Back to Home
              </Text>
            </TouchableOpacity>
          </View>
