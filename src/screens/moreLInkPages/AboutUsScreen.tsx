            ...
            <View className="px-5 mt-6">
                ...
                <View className="flex-row flex-wrap justify-between">
                    <View className="bg-white rounded-xl p-4 shadow-md w-[48%] mb-4">
                        ...
                        <Text className="text-gray-800 font-semibold text-base">Taste First</Text>
                        <Text className="text-gray-600 text-sm">Curating restaurants that prioritize quality and flavor.</Text>
                    </View>
                    <View className="bg-white rounded-xl p-4 shadow-md w-[48%] mb-4">
                        <Text className="text-3xl mb-2">⚡</Text>
                        <Text className="text-gray-800 font-semibold text-base">Speed & Ease</Text>
                        <Text className="text-gray-600 text-sm">Fast orders and bookings, designed for your busy life.</Text>
                    </View>
                    <View className="bg-white rounded-xl p-4 shadow-md w-[48%]">
                        <Text className="text-3xl mb-2">🌍</Text>
                        <Text className="text-gray-800 font-semibold text-base">Local Love</Text>
                        <Text className="text-gray-600 text-sm">Supporting small businesses and vibrant food communities.</Text>
                    </View>
                    <View className="bg-white rounded-xl p-4 shadow-md w-[48%]">
                        <Text className="text-3xl mb-2">😊</Text>
                        <Text className="text-gray-800 font-semibold text-base">Joyful Moments</Text>
                        <Text className="text-gray-600 text-sm">Creating unforgettable dining experiences, every time.</Text>
                    </View>
                </View>
            </View>
