...
const CustormerScreen = () => {
  ...
  return (
    <View className="p-4 pt-10">
      <Text className="text-2xl text-center">Customer Onboard</Text>
      ...
      <Text className="text-xl text-center font-poppins font-bold ">
      ...
      <TouchableOpacity onPress={()=>navigation.navigate("CreateAdScreen")} className="bg-primary-60 w-4/5 mx-auto rounded-lg my-8 p-4">
        <Text className="text-center font-poppins font-bold text-lg">
          Promote a Product
        </Text>
      </TouchableOpacity>
    </View>
